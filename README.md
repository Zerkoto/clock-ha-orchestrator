...
Before implementing live Clock endpoint behavior, update `docs/clock-api-mapping.md` with either official Clock documentation references or sanitized sandbox payloads.
